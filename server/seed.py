...
with app.app_context():
    ...
    uri_2023 = Review(year=2023, summary="Great web developer!", employee=1)
    tristan_2021 = Review(year=2021, summary="Good coding skills, often late to work", employee=2)
    tristan_2022 = Review(year=2022, summary="Strong coding skills, takes long lunches", employee=2)
    tristan_2023 = Review(year=2023, summary="Awesome coding skills, dedicated worker", employee=2)
